...
public class DijalogDodajProfesora extends JDialog {
	...
	private static final long serialVersionUID = -7608051989479209414L;

	public DijalogDodajProfesora(Frame parent, String title, boolean modal) {
		...
		gbcIme.gridx = 0;
		gbcIme.gridy = 0;
		gbcIme.insets = new Insets(20, -70, 0, 10);
